...
const SECTIONS = [
  { action: 'trending',          title: 'Recently Add',          seeMore: '/film'   },
  ...
  { action: 'anime',             title: 'Animasi Pilihan',                seeMore: '/series?cat=anime' },
    ...
    <div>
      ...
      {apiError && !loadingFirst && (
        <div style={{ margin:14, padding:14, background:'#1a0a0a', border:'1px solid #440000', borderRadius:10 }}>
          <div style={{ color:'#ff6b6b', fontSize:12, fontWeight:700, marginBottom:6 }}>Oops Something Wrong...</div>
